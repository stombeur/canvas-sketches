...
let noiseFactor = 0.8;
// grid settings
let margin = 5;//Math.max (30/(Math.max(postcardcolumns, postcardrows)), 10);
let columns = 15;
let rows = 30;
let hashing = 4;
...
let seeds = undefined; //{"seedvalues":["307529","489618","986111","234849","963613","213170"]};
...
const createGrid = (columns, rows, card, noiseFactor = 1) => {
  ...
  let snakegrid = snake.snakefill(rows, columns, { iterations, mergetree: true });
