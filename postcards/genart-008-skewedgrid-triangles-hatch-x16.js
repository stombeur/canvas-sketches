...
const sketch = ({ width, height }) => {
  ...
  return ({ context, width, height, units }) => {
    ...
    const draw = (origin, w, h) => {
      ...
      let grid = createGrid(8, width, height);
        ...
        for (let column = 0; column < grid[row].length; column++) {
          ...
          if (!isLastColumn && !isLastRow) {
            ...
            if ((n1+n2+n3) > 1) {
              ...
              let space = dynspace * (n1+n2+n3) * 0.7; //spacing;
            ...
            if ((n1+n4+n3) > 1) {
              ...
              let space = dynspace * (n1+n4+n3) * 0.7; //spacing;
    ...
    postcards.drawQuadQuad(draw, width, height);
