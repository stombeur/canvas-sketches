...
const sketch = ({ width, height }) => {
    ...
    cards.forEach(card => {
        ...
        card.grid = floodfill(rows, columns, {noise2d: false, iterations: 10000, removeZeroAdjacents: true, weights: { count2s: 10, countMores: -20, countAdjacent: 20, count0s: -5, count1s: -5 }});
        card.elementsize = width/40;
